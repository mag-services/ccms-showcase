  ...
  'dashboard-charts': {
    ...
    buildMockReply: (prompt) =>
      [
        ...
        '',
        '**Mapped widgets (React chart components):**',
        '• **Caseload & origins:** `DashboardOpenVsClosed`, `DashboardFamilyBar`, `DashboardMinistryBar`, `DashboardOwnerBar`.',
        '• **Workflow routing:** `DashboardStageBar`, `DashboardExecutiveMix`.',
        '• **SLA & timeframes:** `DashboardSlaDonut`, `DashboardIllustrativeTrend`, `DashboardSlaStackByFamily`.',
        '• **Oversight & linkage:** `DashboardDecisionAppColumn`, `DashboardLitigationPie`.',
        '',
