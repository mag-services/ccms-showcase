  ...
  'reports-analytics': {
    ...
    buildMockReply: (prompt) =>
      [
        ...
        '',
        '**Suggested visualizations (composer would wire Highcharts here):**',
        '• Stacked column — SLA status × ministry (open matters only).',
        '• Line + band — grievance mediation day-count vs statutory 10-day window.',
        '• Small multiples — senior executive FR-12 vs standard employee throughput.',
        '',
  ...
  'dashboard-insights': {
    ...
    buildMockReply: (prompt) =>
      [
        ...
        '• “Caseload & origins” tab confirms ministry clusters; “SLA & timeframes” tab isolates amber grievance timers.',
        '',
