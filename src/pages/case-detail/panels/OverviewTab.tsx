        ...
        <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          ...
          <dl className="mt-4 grid gap-3 text-sm sm:grid-cols-2">
            <div className="rounded-lg bg-gray-50 px-3 py-2 dark:bg-gray-800/60">
              ...
              <dd className="mt-1 font-medium text-gray-900 dark:text-white">{c.family}</dd>
            </div>
            <div className="rounded-lg bg-gray-50 px-3 py-2 dark:bg-gray-800/60">
              <dt className="text-[11px] font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
                Subject profile
              </dt>
              <dd className="mt-1 font-medium text-gray-900 dark:text-white">{c.subjectLabel}</dd>
            </div>
            <div className="rounded-lg bg-gray-50 px-3 py-2 dark:bg-gray-800/60">
              <dt className="text-[11px] font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
                Ministry account
              </dt>
              <dd className="mt-1 font-medium text-gray-900 dark:text-white">{c.ministry}</dd>
            </div>
            <div className="rounded-lg bg-gray-50 px-3 py-2 dark:bg-gray-800/60">
              <dt className="text-[11px] font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
                Statutory gate
              </dt>
              <dd className="mt-1 font-medium text-blue-900 dark:text-blue-200">{c.stage}</dd>
            </div>
          </dl>
        </section>

        <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          <h2 className="text-sm font-semibold text-gray-900 dark:text-white">Routing & channel (preview)</h2>
          <ul className="mt-3 space-y-2 text-sm text-gray-600 dark:text-gray-400">
            <li>
              <span className="font-medium text-gray-800 dark:text-gray-200">FR-02 pathway:</span> {routing}
            </li>
            <li>
              <span className="font-medium text-gray-800 dark:text-gray-200">Intake channel:</span> {channel}
            </li>
            {c.decisionAppRef ? (
              <li>
                <span className="font-medium text-gray-800 dark:text-gray-200">Decision App sync:</span>{' '}
                <span className="font-mono text-xs text-blue-800 dark:text-blue-300">{c.decisionAppRef}</span> — ministry
      ...
      <aside className="space-y-4">
        ...
        <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          <div className="flex flex-wrap items-center gap-2">
            <h3 className="text-xs font-semibold text-gray-900 dark:text-white">Quick actions (demo)</h3>
            <DemoModeBadge />
          </div>
          <div className="mt-3 flex flex-col gap-2">
            <button
              ...
              className="cursor-pointer rounded-lg bg-blue-700 px-3 py-2 text-xs font-semibold text-white transition hover:bg-blue-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-950"
            >
